<nav class="navbar navbar-expand-lg sticky-top shadow-lg navbar-light foot" >
    <div class="container-fluid">
        <a class="navbar-brand" style="color: #ff7200;" href="#">RK Movie Theatres</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link" style="color: #ff7200;" href="index.php">HOME</a></li>
